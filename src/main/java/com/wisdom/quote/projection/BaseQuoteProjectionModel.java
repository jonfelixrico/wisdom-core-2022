...
public abstract class BaseQuoteProjectionModel {
	protected String id;
	...
	public BaseQuoteProjectionModel(String id, String content, String authorId, String submitterId, Instant submitDt,
